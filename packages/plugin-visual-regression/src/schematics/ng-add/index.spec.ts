...
describe('plugin-visual-regression ng-add', () => {
  it('adds visualRegressionPlugin import + call to empty config', async () => {
    ...
    expect(content).toContain('plugins: [visualRegressionPlugin()]');
  });
