  ...
  projects: [
    {
      ...
      testPathIgnorePatterns: ['\\.browser\\.spec\\.ts$', 'prism-url-state\\.service\\.spec\\.ts$', 'prism-persistence\\.service\\.spec\\.ts$'],
      transform: {
    ...
    },
    {
      ...
      testMatch: ['**/*.browser.spec.ts', '**/prism-url-state.service.spec.ts', '**/prism-persistence.service.spec.ts'],
