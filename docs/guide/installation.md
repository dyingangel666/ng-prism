...
| `cacheDir`          | No            | Override directory for the generated `prism-manifest.ts`. Default: `<workspaceRoot>/.ng-prism/<prismProject>/`. Relative paths resolve against `workspaceRoot`. Useful for CI sandboxes.                                                                                                |
...
import { bootstrapApplication } from '@angular/platform-browser';
import { PrismShellComponent, providePrism } from '@ng-prism/core';
import { PRISM_RUNTIME_MANIFEST } from 'prism-manifest/my-lib-prism'; // generated by the builder into .ng-prism/my-lib-prism/
...
The schematic adds both the path mapping and a workspace-wide `.ng-prism/` entry in `.gitignore` automatically. Background: [ADR 006](../adr/006-manifest-cache-dir.md).
